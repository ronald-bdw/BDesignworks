...
mogenerator --swift --model "${INPUT_FILE_PATH}/" --machine-dir "${PROJECT_DIR}/BDesignworks/CoreData/Private/" --human-dir "${PROJECT_DIR}/BDesignworks/CoreData/" --template-var arc=true
